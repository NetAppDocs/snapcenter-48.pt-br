...
|===
Para obter as informações mais recentes sobre versões suportadas, consulte a. https://imt.netapp.com/matrix/imt.jsp?components=108393;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade do NetApp"]
