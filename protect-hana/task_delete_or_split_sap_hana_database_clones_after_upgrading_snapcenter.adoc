...
. Selecione os clones e clique image:../media/delete_icon.gif["eliminar ícone"] para excluir clones ou clique para image:../media/split_cone.gif["dividir clone"]dividir os clones.
. Clique em *OK*.
