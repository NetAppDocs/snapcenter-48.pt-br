...
** Dados que estão em sistemas primários e secundários ONTAP FAS ou AFF e protegidos no armazenamento de objetos StorageGRID local usando integração de backup e recuperação do NetApp
...
** Dados que estão em sistemas primários e secundários ONTAP FAS ou AFF e protegidos para armazenamento de objetos e arquivos na nuvem usando integração de backup e recuperação do NetApp
