...
+
** image:../media/controller_licensed_icon.gif["Um ícone de verificação"] Indica que uma licença do SnapManager Suite está instalada em um sistema de storage primário FAS ou AFF.
** image:../media/controller_not_licensed_icon.gif["Um ícone de cancelamento"] Indica que uma licença do SnapManager Suite não está instalada em um sistema de storage primário FAS ou AFF.
...
+
Para obter informações sobre os cmdlets, https://docs.netapp.com/us-en/snapcenter-cmdlets-48/index.html["Guia de referência de cmdlet do software SnapCenter"^] consulte .
