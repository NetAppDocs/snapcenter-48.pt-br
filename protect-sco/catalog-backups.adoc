...
As informações sobre os parâmetros que podem ser usados com o comando e suas descrições podem ser obtidas executando get-Help command_name. Em alternativa, pode consultar a https://library.netapp.com/ecm/ecm_download_file/ECMLP2883301["Guia de Referência de comandos do software SnapCenter"^].
